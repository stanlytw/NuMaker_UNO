...
BoardToPin BoardToPinInfo[] =
{
    ...
    { 21, ADC_TYPE, 5},  // PB1(EADC_CH)    (A5/I2C1_SCL)

    { 8, PWM_TYPE,  6},  // PA5(PWM0_CH1)   (D8/PWM6)
    { 9, PWM_TYPE,  7},  // PA4(PWM0_CH0)   (D9/PWM7)
    { 10, SPI_TYPE,  0}, // PA3(SPI0_CS)    (D10/SPI0_CS)
    { 11, SPI_TYPE,  0}, // PA0(SPI0_MOSI)  (D11/SPI0_MOSI)
    { 12, SPI_TYPE,  0}, // PA1(SPI0_MISO)  (D12/SPI0_MISO)
    { 13, SPI_TYPE,  0}, // PA2(SPI0_SCK)   (D13/SPI0_SCK)
    { 14, I2C_TYPE,  0}, // PC0(I2C0_SDA)   (I2C0_SDA)
    { 15, I2C_TYPE,  0}, // PC1(I2C0_SCL)   (I2C0_SCL)
    ...
    { 25, SPI_TYPE,  1}, //43: PA8(USCI0_CTL1)     (SS)
...
GPIOPinDescription GPIO_Desc[] =
{
   ...
   /* SS,  PA8    ,24 */  {PA, BIT8,   {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA8MFP_Msk,  SYS_GPA_MFPH_PA8MFP_GPIO  }},//24 
   /* MOSI,PA10   ,25 */  {PA, BIT10,  {(uint32_t) &SYS->GPA_MFPH, SYS_GPA_MFPH_PA10MFP_Msk, SYS_GPA_MFPH_PA10MFP_GPIO }},//25 
...
SPIPinDescription SPI_Desc[] =
{
    ...
    {   
        { 23, SYS_GPA_MFPH_PA11MFP_USCI0_CLK }, { 25, SYS_GPA_MFPH_PA10MFP_USCI0_DAT0},
        
        { 22, SYS_GPA_MFPH_PA9MFP_USCI0_DAT1},  { 24, SYS_GPA_MFPH_PA8MFP_GPIO},
